...
namespace Blog.Controllers
{
    public class MensagemController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MensagemId,Título,Descricao,DataMensagem,CategoriaId")] Mensagem mensagem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MensagemId,Título,Descricao,DataMensagem,CategoriaId")] Mensagem mensagem)
        {
